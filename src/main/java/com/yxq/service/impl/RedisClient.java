...
//	private ShardedJedisPool sharded_pool;
//	public RedisClient(JedisPoolConfig config,List<JedisShardInfo> shards ){
//		if (sharded_pool == null) {
//			sharded_pool = new ShardedJedisPool(config, shards);
//		}
//	}
